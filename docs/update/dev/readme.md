## 2023-07-04 <Badge text="Ver:3.4.0"/>
### [修改表]
+	<数据>好感数据_打怪亲密
	>[obj]        修改类型[VARCHAR(36)]<br>
	>[Cobj]       修改类型[VARCHAR(36)]
+	<数据>婚宴数据
	>[obj]        修改类型[VARCHAR(36)]<br>
	>[Cobj]       修改类型[VARCHAR(36)]
+	<数据>参宴数据
...
## 2023-06-29 <Badge text="Ver:3.4.0"/>
### [新增表]  
+	<系统>reply_custom  
	>[name]		名称  
	>[type]		类型  
...
### [新增数据表]
+ <数据>record_user_skill
   >[user]用户<br>
   >[skill]技能<br>
   >[wait]冷却
### [修改数据表]
+ <数据>玩家技能 :point_right: data_user_skill
